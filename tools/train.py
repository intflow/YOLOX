...
def make_parser():
    ...
    parser.add_argument("-n", "--name", type=str, default="yolox_oad_e2e_simple_s", help="model name")
    ...
    #parser.add_argument("-c", "--ckpt", default='YOLOX_outputs/yolox_oad_e2e_simple_s-intflow_total_1K/latest_ckpt.pth', type=str, help="checkpoint file")
