    ...
    std::vector<NvDsInferParseObjectInfo>& objectList)
{
    ...
    for(auto& r : objects) {
	    ...
	    // oinfo.landmarksX2  = static_cast<unsigned int>(landmarks_x2);
	    // oinfo.landmarksY2  = static_cast<unsigned int>(landmarks_y2);
	    // oinfo.landmarksX3  = static_cast<unsigned int>(landmarks_x3);
	    // oinfo.landmarksY3  = static_cast<unsigned int>(landmarks_y3);
	    oinfo.detectionConfidence = r.prob;
        std::cout<<"[decoder]"<<oinfo.classId<<"="<<oinfo.left<<","<<oinfo.top<<","<<oinfo.landmarksY1<<","<<oinfo.theta<<","<<std::endl;
